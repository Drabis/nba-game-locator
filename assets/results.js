...
function getStats(teamID) {
  fetch(
    "https://api-basketball.p.rapidapi.com/statistics?league=12&season=2020-2021&team=" +
      teamID,
    {
      method: "GET",
      headers: {
...
function displayTeamData(data) {
  ...
  teamTitle.setAttribute(
    "style",
    "background-color: #000; font-family: 'Anton', sans-serif; font-size: var(--title-font);"
  );
...
$.ajax({
  ...
  url:
    ...
    team +
    "&apikey=wkeUKU7nGwu8KaAr6CW0pqhy3LP5gh4f",
  async: true,
  dataType: "json",
